package com.auditx.notification.config;

import com.auditx.common.dto.AlertDto;
import com.auditx.common.dto.NotificationDto;
...
public class KafkaConfig {
    ...
    // Producer — NotificationDto

    @Bean
    public ProducerFactory<String, NotificationDto> notificationProducerFactory(ObjectMapper objectMapper) {
        Map<String, Object> props = new HashMap<>();
        ...
        DefaultKafkaProducerFactory<String, NotificationDto> factory =
